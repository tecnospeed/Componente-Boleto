...
namespace APISoftwareHouse
{
    public partial class Form1 : Form
    {
        ...
        {
            //Método que recebe o arquivo de retor, gerado pelo Banco, e envia para nossa API, para que os boletos já emitidos sejam atualizados.
        ...
        private void button3_Click_2(object sender, EventArgs e)
        {
            ...
            var client = new RestClient(url + "/api/v1/email/lote/" + txtProtocoloEmail.Text);
            var request = new RestRequest(Method.GET);
            request.AddHeader("cache-control", "no-cache");
            request.AddHeader("content-type", "application/pdf");
            request.AddHeader("token-sh", tokenSH);
