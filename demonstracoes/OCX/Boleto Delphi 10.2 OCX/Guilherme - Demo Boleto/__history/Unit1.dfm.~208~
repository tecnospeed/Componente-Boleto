object frmExemploBoletoX: TfrmExemploBoletoX
  ...
  object grpImpressao: TGroupBox
    ...
    object cbbTipoImpressao: TComboBox
      ...
      Items.Strings = (
        ...
        '4 - Impress'#227'o com Marca D'#39#225'gua'
  ...
  object PageControlConfiguracoes: TPageControl
    ...
    object TabSheetConfiguracoes: TTabSheet
      ...
      object edtTokenSoftwareHouse: TMaskEdit
        Left = 140
        Top = 73
        Width = 185
        Height = 21
        Hint = 'Campo que recebe o token de autentica'#231#227'o da Software House.'
        ParentShowHint = False
        PasswordChar = #176
        ShowHint = True
        TabOrder = 5
    ...
    object TabSheetCadCedente: TTabSheet
      ...
      object btnAlterarCedente: TButton
        Left = 216
        Top = 12
        Width = 110
        Height = 25
        Caption = 'Alterar Cedente'
        TabOrder = 4
        OnClick = btnAlterarCedenteClick
      end
      object edtIDConta: TEdit
        Left = 133
        Top = 72
        Width = 65
        Height = 21
      ...
      object edtIDConvenio: TEdit
        ...
        ParentFont = False
        TabOrder = 6
        Text = 'ID Conv'#234'nio'
      end
      object btnAlterarConta: TButton
        Left = 216
        Top = 71
        Width = 110
        Height = 25
        ...
        TabOrder = 7
        OnClick = btnAlterarContaClick
      end
      object btnAlterarConvenio: TButton
        Left = 216
        Top = 131
        Width = 110
        Height = 25
        Caption = 'Alterar Conv'#234'nio'
        TabOrder = 8
        OnClick = btnAlterarConvenioClick
      end
    end
  end
  object AbrirPDFGravado: TOleContainer
    Left = 992
    Top = 456
    Width = 25
    Height = 25
